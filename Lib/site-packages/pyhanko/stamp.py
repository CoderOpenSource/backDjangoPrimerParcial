...
class TextStampStyle(BaseStampStyle):
    ...
    stamp_text: str = '%(ts)s'
    """
    Text templates for the stamp. The templates can contain an interpolation
...
class TextStamp(BaseStamp):
    ...
    def get_default_text_params(self):
        ...
        to be applied to the templates string specified in the stamp
...
def text_stamp_file(
    ...
    :param y:
        Vertical position of the stamp's lower left corner on the page.
    :param text_params:
        Additional parameters for text templates interpolation.
    """
    _stamp_file(
        input_name,
        output_name,
